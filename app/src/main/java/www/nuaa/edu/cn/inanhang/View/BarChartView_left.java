 ...
 */
public class BarChartView_left extends GraphicalView {

    private String TAG = "BarChartView_left";
    ...
    public BarChartView_left(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public BarChartView_left(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
    }

    public BarChartView_left(Context context, AttributeSet attrs, int defStyle) {
...
//            chart.getAxisTitle().setLeftTitle("参考成年男性标准值");
            ...
            //数据轴
            chart.getDataAxis().setAxisMax(210);
            chart.getDataAxis().setAxisMin(0);
            chart.getDataAxis().setAxisSteps(35);
            //指隔多少个轴刻度(即细刻度)后为主刻度
    ...
    private void chartDesireLines()
    {
        ...
        cl.setLabelHorizontalPostion(Paint.Align.LEFT);
        cl.hideLine();
